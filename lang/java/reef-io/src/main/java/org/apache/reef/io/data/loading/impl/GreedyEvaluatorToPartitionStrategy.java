 ...
 */
@DriverSide
public final class GreedyEvaluatorToPartitionStrategy extends AbstractEvaluatorToPartitionStrategy {
  private static final Logger LOG = Logger
      .getLogger(GreedyEvaluatorToPartitionStrategy.class.getName());

  @Inject
  GreedyEvaluatorToPartitionStrategy() {
    LOG.fine("GreedyEvaluatorToPartitionStrategy injected");
  }
